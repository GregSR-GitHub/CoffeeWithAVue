<template>
  <div id="app" class="app">
        ...
        />
			...
			<p>Adresse : {{ restaurantAdress }}</p>
			<p>Téléphone : {{ restaurantPhone }}</p>
			<p>Email : {{ restaurantMail }}</p>
			<p>Horaires :</p>
			<ul>
...
<script>
  ...
  export default {
    ...
    data(){  
      ...
      restaurantAdress: '18 avenue du Beurre, Paris, France',
      restaurantPhone: '01 88 88 88 88',
      restaurantMail: 'hello@cafewithavue.bakery',
      shoppingCart: 0,
      simpleMenu: [
        {
          name: "Croissant",
